...
{for(var i = 0, len = gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects2.length ;i < len;++i) {
    gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setTypedText(gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getTypedText() + (eventsFunctionContext.localVariables[0].getFromIndex(0).getAsString()));
}
}
{for(var i = 0, len = gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects2.length ;i < len;++i) {
...
{for(var i = 0, len = gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setTypedText(eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getFullText());
}
}
{for(var i = 0, len = gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects1.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
{
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.ClearForcedLineBreakContext.GDObjectObjects1);
{for(var i = 0, len = gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.ClearForcedLineBreakContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__AutoTyping__AutoTyping.AutoTyping.prototype.ClearForcedLineBreakContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setTypedText(gdjs.evtTools.string.subStr(eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getFullText(), 0, gdjs.evtTools.string.strLen(eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getTypedText())));
}
}
}
