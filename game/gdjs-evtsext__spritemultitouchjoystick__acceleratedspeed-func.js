...
{isConditionTrue_0 = ((Number(eventsFunctionContext.getArgument("CurrentSpeed")) || 0) < eventsFunctionContext.getArgument("TargetedSpeed"));
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = ((Number(eventsFunctionContext.getArgument("CurrentSpeed")) || 0) < 0);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = ((Number(eventsFunctionContext.getArgument("TargetedSpeed")) || 0) < 0);
}
if (isConditionTrue_0) {
